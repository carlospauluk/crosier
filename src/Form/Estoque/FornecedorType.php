...
class FornecedorType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('tipo', EntityType::class, array(
            'class' => FornecedorTipo::class,
            'choice_label' => function (FornecedorTipo $fornecedorTipo) {
                return $fornecedorTipo->getDescricao();
            }
        ));

        $builder->add('representante', TextType::class, array(
            'label' => 'Representante',
            'required' => false
        ));

        $builder->add('representanteContato', TextType::class, array(
            'label' => 'Representante Contato',
            'required' => false
        ));
